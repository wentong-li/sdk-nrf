...
#define CPUNET_UARTE_PIN_TX 9
#define CPUNET_UARTE_PIN_RX 8
...
static void remoteproc_mgr_config(void)
{
	 ...
	 * nRF5340 Network MCU.
	 */
	CPUNET_UARTE_PORT_TRX->PIN_CNF[CPUNET_UARTE_PIN_TX] = GPIO_PIN_CNF_MCUSEL_NetworkMCU
							      << GPIO_PIN_CNF_MCUSEL_Pos;
	CPUNET_UARTE_PORT_TRX->PIN_CNF[CPUNET_UARTE_PIN_RX] = GPIO_PIN_CNF_MCUSEL_NetworkMCU
							      << GPIO_PIN_CNF_MCUSEL_Pos;
	CPUNET_UARTE_PORT_TRX->PIN_CNF[CPUNET_UARTE_PIN_RTS] = GPIO_PIN_CNF_MCUSEL_NetworkMCU
							       << GPIO_PIN_CNF_MCUSEL_Pos;
	CPUNET_UARTE_PORT_TRX->PIN_CNF[CPUNET_UARTE_PIN_CTS] = GPIO_PIN_CNF_MCUSEL_NetworkMCU
							       << GPIO_PIN_CNF_MCUSEL_Pos;
