...
COMP_FLAG_RELEASE = ' -DCMAKE_BUILD_TYPE=RELEASE '
COMP_FLAG_DEBUG = ' -DCMAKE_BUILD_TYPE=DEBUG '
COMP_FLAG_DEV_HEADSET = ' -DDEV_HEADSET=ON '
COMP_FLAG_DEV_GATEWAY = ' -DDEV_GATEWAY=ON '
