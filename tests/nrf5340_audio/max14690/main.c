...
{
	ztest_test_suite(
		test_suite_max14690, ztest_unit_test(test_init_ok),
		...
		ztest_unit_test(test_ldo_1_cfg_enable_set), ztest_unit_test(test_ldo_1_cfg_dsc_set),

		ztest_unit_test(test_ldo_2_cfg_mode_set),
		ztest_unit_test(test_ldo_2_cfg_enable_set), ztest_unit_test(test_ldo_2_cfg_dsc_set),

		ztest_unit_test(test_ldo_3_cfg_mode_set),
		ztest_unit_test(test_ldo_3_cfg_enable_set), ztest_unit_test(test_ldo_3_cfg_dsc_set),

		ztest_unit_test(test_pwr_cfg_stay_on_set),
		ztest_unit_test(test_pwr_cfg_stay_on_clear),

		ztest_unit_test(test_pwr_cfg_pfn_set), ztest_unit_test(test_pwr_cfg_pfn_clear),
