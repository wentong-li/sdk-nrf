...
{
	ztest_test_suite(
		test_suite_pscm, ztest_unit_test(test_pscm_zero_pad_16),
		ztest_unit_test(test_pscm_copy_pad_16), ztest_unit_test(test_pscm_combine_16),
		ztest_unit_test(test_pscm_one_channel_split_16),
		ztest_unit_test(test_pscm_two_channel_split_16),
		ztest_unit_test(test_pscm_zero_pad_24), ztest_unit_test(test_pscm_copy_pad_24),
		...
		ztest_unit_test(test_pscm_zero_pad_32), ztest_unit_test(test_pscm_copy_pad_32),
