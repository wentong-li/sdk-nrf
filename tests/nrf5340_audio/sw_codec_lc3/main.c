...
void test_sw_codec_lc3_init(void)
{
	...
	ret = sw_codec_lc3_enc_init(PCM_SAMPLE_RATE, PCM_BIT_DEPTH, LC3_BITRATE, LC3_FRAME_SIZE_US,
...
void test_main(void)
{
	ztest_test_suite(test_suite_sw_codec_lc3, ztest_unit_test(test_sw_codec_lc3_init),
