...
static void internal_test_remaining_elements(data_fifo_t *data_fifo, uint32_t num_alloced_tgt,
...
{
	DATA_FIFO_DEFINE(data_fifo, 8, 1024);
...
#define BLOCKS_NUM 10
	DATA_FIFO_DEFINE(data_fifo, 10, 1024);
